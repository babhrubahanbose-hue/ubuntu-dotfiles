    ...
    this._settingsKeys.connectSettings(this._settings, (name, value) => {
      ...
      switch (name) {
        ...
        case 'control-button-style':
          ...
          break;
        case 'inner-border-thickness':
        case 'outer-border-thickness':
        case 'inner-outline-color':
        case 'outer-outline-color':
        case 'unfocused-inner-outline-color':
        case 'unfocused-outer-outline-color':
